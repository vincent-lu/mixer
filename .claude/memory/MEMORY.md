...
- [UI wiring](project_ui-wiring.md) — next task: wire Electron UI to mixing pipeline
- [BPM analysis](project_bpm-analysis.md) — queued: replace fixed-interval with beat detection
